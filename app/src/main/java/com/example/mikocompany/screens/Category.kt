...
import com.example.mikocompany.dcl.CategoryClass
    ...
    MikoNavigation(
        ...
        Column(
            ...
            Row(
                ...
                MikoButton(
                    onClick = {
                        navController.navigate("categoryAdd")
                    },
            ...
            ) { items(CategoryClass.categoryAll){ item ->
                if (item != null){
                    categoryColumn(navController, item)
                }
            }
            }
        }
...
fun categoryColumn(
    ...
    MikoBackCard(
        ...
        modifier = Modifier
            .fillMaxWidth(0.88F)
            .clickable {
                navController.navigate("categoryInfo")
            }
    ) {
        Row(
            modifier = Modifier
